...
plt.tight_layout()
plt.savefig("losses_cdf.svg", bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("losses_histogram.svg", bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("losses_histogram_no_zero.svg", bbox_inches="tight")
plt.show()
